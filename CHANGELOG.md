...
- Add the `preview-django-page` skill and its development-only, memory-backed
  Django template rendering helper.
- Bootstrap the `mad-skills` profiles, configuration, CLI, checks, shared skills,
  documentation, and Codex/Claude installation workflow.
